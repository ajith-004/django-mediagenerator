...
class UglifyJSCompressor(Filter):
    def __init__(self, **kwargs):
        super(UglifyJSCompressor, self).__init__(**kwargs)
        assert self.filetype in ('js'), (
            'UglifyJSCompressor only supports compilation of js. '
        ...
        for input in self.get_input(variation):
            try:
                ...
                raise ValueError("Failed to execute uglifyjs. "
                    "Please make sure that you have installed UglifyJS "
